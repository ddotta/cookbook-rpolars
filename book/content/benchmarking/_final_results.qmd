...
mem_plot <- ggplot(memory_usage_df, 
                   aes(x = change,
                       y = fct_relevel(
                         ...
                         "dplyr - from csv file",
                         "R base - from csv file"))) +
  geom_col(fill = c("orange","orange","red","orange",
                            "orange","orange","red","blue",
                            "blue","blue","green","red","blue")) +
...
Now let's combine the two plots by placing them side by side:

```{r}
#| label: combining-plots

speed_plot + mem_plot +
  plot_annotation("🔎 Right-click on the plot to open it wide in a new tab")
```
