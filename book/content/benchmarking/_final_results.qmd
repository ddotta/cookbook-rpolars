...
autoplot(bmk_results) +
  ...
  theme(axis.text.y = element_text(color = c('blue', 'red', 'green', 'blue', 'blue', 'blue',
                                             'red', 'orange','orange', 'orange', 'red', 'orange','orange'))) +
  aes(color = expr) +
  scale_color_manual('Functions', values = c('blue', 'red', 'green', 'blue', 'blue', 'blue',
                                             'red', 'orange','orange', 'orange', 'red', 'orange','orange'))
```
...
ggplot(memory_usage_df, aes(x = change, y = functions)) +
  geom_col(fill =  c('blue', 'red', 'green', 'blue', 'blue', 'blue',
                     'red', 'orange','orange', 'orange', 'red', 'orange','orange')) +
