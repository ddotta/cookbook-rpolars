...
```
 ...
 2 REMARQUES :
 - Avec data.table, il y a 2 étapes supplémentaires (la conversion au format dt au début puis la conversion en data.frame à la fin)
 - Avec polars, la conversion en data.frame