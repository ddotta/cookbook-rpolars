...
![](../images/polars_lucida_console.png){fig-alt="Displaying the mtcars DataFrame with Lucida Console font."}

To resolve this display problem, I recommend using the "Cascadia" font:

![](../images/polars_cascadia.png){fig-alt="Displaying the mtcars DataFrame with Cascadia font."}
