...
::: {.callout-note}
We can deduce from this cross-reference table that if we want to create a categorical column in a DataFrame, we can proceed for example as follows:
```{r}
#| label: creation-categorical-column
