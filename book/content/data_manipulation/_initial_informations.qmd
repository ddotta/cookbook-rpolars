...
You can access a dense preview of a `DataFrame` by using the `glimpse()` method.  
...
Polars API contains useful method for quickly describing a `DataFrame` - for example  [describe](https://pola-rs.github.io/polars/py-polars/html/reference/dataframe/api/polars.DataFrame.describe.html) has not yet been implemented (July 2023).
:::
