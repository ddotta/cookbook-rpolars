...
Alternatively, the `nrow.DataFrame()` method can be used to get the width of a 
`DataFrame`.
...
Alternatively, the `ncol.DataFrame()` method can be used to get the height of a 
`DataFrame`.
