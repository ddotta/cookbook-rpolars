...
Most of this book is structured examples of Polars, tidypolars, dplyr and data.table idiomatic code, with comments on the API and performance of the three.
