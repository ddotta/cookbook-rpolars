...
```{r}
#| label: creation-df-for-pivot
df <- data.frame(
  country = c(rep("France",3),rep("Italy","3")),
  city = c("Paris", "Marseille", "Toulouse", "Roma", "Milan", "Napoli"),
  location = c("North","South","South","South","North","South"),
  population = c(2.1, 0.8, 0.5, 2.8, 1.4, 3.0)
)
```
...
You can also aggregate the results using a function that you enter in the argument `aggregate_function`:
...
reshape(df_summary, idvar = "country", timevar = "location", direction = "wide")
```
