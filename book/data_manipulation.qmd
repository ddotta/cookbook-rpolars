...
::: {.callout-caution}
Polars API contains a [describe](https://pola-rs.github.io/polars/py-polars/html/reference/dataframe/api/polars.DataFrame.describe.html) method that has not yet been implemented (end of May 2023).
:::
